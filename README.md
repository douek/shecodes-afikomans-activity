...
&#x202b; הבנות יקבלו תבנית לכתוב את הקוד שעליה הן יוסיפו את הקוד שיוסבר בהמשך בכל צעד.

&#x202b; תשמשו בהערות שכתובות כדי להסביר בדיוק איפה הקוד צריך להכנס
...
&#x202b; אפשר להסביר שwindow זה החלון של הדפדפן ושאפשר להפעיל פעולות עליו

&#x202b; אפשר לשים איזה טקסט שרוצות בהתראה שקופצת
...
&#x202b;אירועים(Evants) אלו פעולות או התרחשויות אשר קורות במערכת שאנחנו מתכנתים בה, והמערכת אומרת לנו  בדרך מסויימת על ההתרחשות שלהם, כך שאנחנו יכולים להגיב להתרחשות של האירוע המסויים בדרך מסויימת שנרצה. לדוגמא אם משתמש לחץ על כפתור באתר, אולי נרצה בתגובה לטפל באירוע הלחיצה הזה על ידי הצגת הודעה כלשהי.
...
- אם הסמן הוא על הקוד אז זה לא יעבוד - הן צריכות ללחוץ על החלק הירוקואז לנסות את התבנית
